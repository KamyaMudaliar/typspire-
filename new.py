...
def random_quotes():
    global a1
    global lst4
    # Function that appends time into the list
    def return_pressed1():
        start_q= timer()
        lst_q.append(start_q)
    ...
    if a1!=0:
        ...
        window_rq=tk.Tk()
        tk.Label(window_rq, text= "Enter the given quote").place(x=0, y=0)
        window_rq.mainloop()
